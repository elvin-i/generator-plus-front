            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="状态">
                <a-select mode="multiple" v-model="queryParam.states" placeholder="请选择" default-value="0">
                  ...
                  <a-select-option value="5">执行成功</a-select-option>
                  <a-select-option value="6">执行失败</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
...
import AddOrEditForm from '@/views/frame/archetypesExecute/addOrEditForm'
import InfoTable from '@/views/frame/archetypesExecute/infoTable'
  ...
  methods: {
    ...
    handleDelete (id) {
      ...
      this.$confirm({
        ...
        onOk () {
          request({
            url: '/archetypesExecute/deleteById',
            method: 'post',
            dataType: 'json',
            data: commonRequest
          }).then(res => {
